                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 15px; background-color: #e3f2fd; border: 1px solid #90caf9; border-radius: 6px;">
                                                    <tr>
                                                        <td style="padding: 15px;">
                                                            ...
                                                            <p style="margin: 0 0 8px 0; font-size: 13px; color: #333333; font-family: Arial, Helvetica, sans-serif;"><strong>Account Owner:</strong> ${registration.distance.event.seller?.name}</p>
