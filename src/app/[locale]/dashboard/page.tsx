            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6 border-b border-zinc-800 pb-8">
                    ...
                    <div className="flex gap-4">
                        ...
                        {/* Logout button handled by NextAuth usually, but for now just link or form */}
                        <form action="/api/auth/signout" method="post">
                            <button className="bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 text-zinc-400 hover:text-white px-4 py-2 rounded-lg font-bold flex items-center gap-2 transition-colors">
